...
const Footer = () => {
    return (
        ...
        <footer className={`"bg-white" mt-10 rounded-lg`}>
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://talent-hunt.com/" className="hover:underline">talent-hunt.com</a>
                                </li>
                                <li>
                                    <a href="https://talent-hunt.com/" className="hover:underline">Full stack Project</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://talent-hunt.com" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="https://talent-hunt.com" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="flex justify-center">
                    <span className="text-sm text-gray-500">© 2023 Talent Hunt™ . All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>

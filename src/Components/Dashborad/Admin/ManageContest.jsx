...
import { ContestDataAdmin, DeleteContest, UpdateContest } from "../../../API/Contest";
...
const ManageContest = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const data = await ContestDataAdmin(user?.email);
      console.log(data);
      return data;
    },
  });
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div>
          <h1 className="text-center font-bold text-4xl my-5">Manage Contest</h1>
                <hr />
